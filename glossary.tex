...
\newglossaryentry{git}{
  name=git,
  description={A free program to version software code. Users create a git repository in a folder, and then track and version all the files inside that folder}
}
...
\newglossaryentry{artifact}{
  name={artifact},
  description={The term \textit{artifact} means something artificial or human created, instead of something occurring in nature~\cite[p.~6]{alanhevnerDesignResearchInformation2010}.}
}
...
\newacronym{TLSP}{TLSP}{Tree Language Server Protocol}