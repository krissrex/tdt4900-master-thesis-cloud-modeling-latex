...
Tackling all the aspects of \acrshort{MDD} abd \gls{TDT4250} in this thesis is unrealistic, because of the size of work.

The scope is therefore limited to \textbf{creating and editing model files}.
