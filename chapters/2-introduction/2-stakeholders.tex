...
% Next year's master students (continue work on the project)
% VSCode extension developers (that want to create tree editors, or develop similar editor protocols)
% TypeFox
% EclipseSource
% RedHat
% Gitpods
