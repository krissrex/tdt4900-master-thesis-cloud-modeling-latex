...
\documentclass[american,twoside]{ntnuthesis}
...
Education}
\shorttitle{Modeling in the Cloud for Education}
\author{Kristian Rekstad}
\shortauthor{K. Rekstad}
\date{\parbox{\linewidth}{\centering%
  {June~18,~2021}\endgraf\bigskip
...
\appendix
\input{appendices/pre-project-functional-requirements.tex}
\input{appendices/pre-project-tree-structure.tex}
